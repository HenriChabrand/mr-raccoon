    ...
    if (all_required) {
        ...
        require('request')(call, function(error, response, body) {
            if (!error && response.statusCode == 200) {
                ...
                if(!json.input.temperature){ json.input.temperature = {}; }
                if(!json.input.temperature.data){ json.input.temperature.data = {}; }
                json.input.temperature.data.value = info.currently.temperature;
